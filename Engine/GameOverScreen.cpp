...
void GameOverScreen::DesplayGameOver()
{
	...
	scoreText->SetPosition(Float3(-75.0f, 100.0f));
	...
	resetButton->SetPosition(Float3(-150.0f, -0.0f));
	uiManager->AddComponet(resetButton);
	menuButton = new UIButton("../Engine/data/UI/MainMenuButton.tga", PivotPosition::Center);
	__hook(&UIButton::onClickTrigger, menuButton, &GameOverScreen::LoadMainMenu);
	menuButton->SetPosition(Float3(-150.0f, -150.0f));
