...
////////////////////////////////////////////////////////////////////////////////
class MaskedTextureshaderclass :public Shader
{
private:
...
public:
	MaskedTextureshaderclass();
	MaskedTextureshaderclass(const MaskedTextureshaderclass&);
	~MaskedTextureshaderclass();
...
private:
	...
	bool SetShaderParameters(ID3D11DeviceContext*, const XMMATRIX&, const XMMATRIX&, const XMMATRIX&, std::vector< ID3D11ShaderResourceView*>*, XMFLOAT4);
