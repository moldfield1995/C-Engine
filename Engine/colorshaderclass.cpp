...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../Engine/colorVertex.hlsl", L"../Engine/colorPixle.hlsl");
	if(!result)
	{
		return false;
	}
...
bool ColorShaderClass::Render(ID3D11DeviceContext * context, int indexCount, const XMMATRIX & worldMatrix, const XMMATRIX & viewMatrix, const XMMATRIX & projectionMatrix, std::vector< ID3D11ShaderResourceView*>* textures, LightClass * light, void* shaderData)
{
	bool result;
